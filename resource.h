...
#define IDR_PCBcircleDetectTYPE         130
...
#define ID_FILE_UPLOADIMAGE             32771
#define ID_OPERATIONS_DISTBETCENTERS    32772
#define ID_OPERATIONS_DIAMETER          32773
